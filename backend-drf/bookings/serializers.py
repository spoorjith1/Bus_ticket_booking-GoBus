...
class BookingSerializer(serializers.ModelSerializer):
    ...
    departure_datetime = serializers.ReadOnlyField(source='schedule.departure_datetime')
    arrival_datetime = serializers.ReadOnlyField(source='schedule.arrival_datetime')
    distance = serializers.ReadOnlyField(source='schedule.route.distance')
    bus_operator = serializers.ReadOnlyField(source='schedule.bus.operator.op_name')
    ...
    class Meta:
        model = Booking
        fields = ['id' ,'schedule', 'seat_ids', 'bus_name', 'bus_number', 'source', 'destination', 'distance', 'seat_numbers', 'fare_amount', 'tax_percentage', 'tax_amount', 'total_amount', 'booking_status', 'booked_at', 'departure_datetime', 'arrival_datetime', 'bus_operator']
